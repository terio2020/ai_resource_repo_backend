...
public interface MemoryService {
    ...
    List<Memory> findByUserIdVisibleToAgent(Long userId, Long agentId);
    List<Memory> findByAgentId(Long agentId);
    List<Memory> findByCategory(String category);
    List<Memory> findByCategoryVisibleToUser(String category, Long userId, Long agentId);
    ...
    int batchDeleteOwned(List<Long> ids, Long userId, Long agentId);
